...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference("Employer.count") do
      post employers_url, params: { employer: { category: @employer.category, certified_year: @employer.certified_year, name: @employer.name } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { category: @employer.category, certified_year: @employer.certified_year, name: @employer.name } }
